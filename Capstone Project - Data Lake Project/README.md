...
- Use AWS EMR & Spark to process the data. This can be executed after creating a AWS EMR cluster, copying capstone.cfg and capstone.py files to hadoop file system then executing python file with the spark-submit command.
