...
4. Build ETL processes by following instructions in elt.ipynb to confirm insertions were successful. Don't forget to restart kernel after each execution of test.ipynb.
